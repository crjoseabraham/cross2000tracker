<div class="p-6">
    <h1 class="text-xl">Editar datos de {{ $name }}</h1>
    ...
    <div>
        ...
        <form wire:submit.prevent="save" method="POST">
            <div class="mb-4">
                ...
                <input
                    class="border border-gray-300 appearance-none rounded w-full py-2 px-3 text-gray-700 focus:outline-none"
                    id="name" name="name" wire:model.defer="name" type="text" required>
            </div>
            <div class="mb-4">
                ...
                <select required
                    ...
                    id="gender" name="gender" wire:model.defer="gender">
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    id="dob" name="dob" wire:model.defer="dob" type="date">
            </div>
